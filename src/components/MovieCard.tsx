...
export default function MovieCard({ title, image, year, rating }: MovieCardProps) {
  return (
    <div className="w-40 flex-shrink-0 cursor-pointer group rounded-xl overflow-hidden bg-[#181e23] shadow transition-shadow duration-200 hover:shadow-2xl">
      ...
      <div className="flex flex-col gap-1 px-2 pb-3">
        <span className="text-base font-semibold text-[#f9f8ff] truncate mb-0.5">{title}</span>
